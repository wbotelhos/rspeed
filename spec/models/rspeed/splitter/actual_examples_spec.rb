...
RSpec.describe RSpeed::Splitter, '#actual_examples' do
  it 'returns all examples' do
    expect(described_class.actual_examples(spec_path: './spec/fixtures/**/*_spec.rb')).to eq [
  ...
  it 'does not raise when no file match' do
    expect(described_class.actual_examples(spec_path: './spec/fixtures/**/*_missing.rb')).to eq []
  end

  it 'does not raise when file is empty' do
    expect(described_class.actual_examples(spec_path: './spec/fixtures/**/empty.rb')).to eq []
  end
end
